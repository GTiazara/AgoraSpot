...
router.get("/", async (req, res) => {
    try {
        ...
        const prompt = "my app generates facts about a location. generate a historic, geophique, scientifique,... fact about a random location in the world (anywhere, from big to little historique event, make sure it's unique at each request and from diffrent country) as geojson type Feature format with properties (fact, adress, location)";
